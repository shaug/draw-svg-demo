...
public class Bezier {
    ...
    public FloatingPoint startPoint;
    public FloatingPoint control1;
    public FloatingPoint control2;
    public FloatingPoint endPoint;


    public Bezier(FloatingPoint startPoint, FloatingPoint control1, FloatingPoint control2, FloatingPoint endPoint) {
